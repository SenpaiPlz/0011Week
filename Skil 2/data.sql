...
CREATE TABLE "computers" ("id" INTEGER PRIMARY KEY  NOT NULL ,"name" VARCHAR NOT NULL  DEFAULT (null) ,"year" INTEGER NOT NULL ,"type" VARCHAR NOT NULL  DEFAULT (null) ,"built" BOOL NOT NULL ,"deleted" BOOL DEFAULT (null) );
...
CREATE TABLE "scientists" ("id" INTEGER PRIMARY KEY  NOT NULL ,"first_name" VARCHAR NOT NULL ,"middle_name" VARCHAR,"last_name" VARCHAR NOT NULL ,"gender" VARCHAR NOT NULL ,"birth_year" INTEGER NOT NULL ,"death_year" INTEGER NOT NULL ,"deleted" BOOL NOT NULL  DEFAULT (null) );
